...
import SupplierInformation from '../../../../components/admin-moderator/SupplierDetails';
...
const SupplierDetails = (props) => {
    ...
    const supplier = suppliers.find(supplier=> supplier.supplierId == router.query.supplierId);
    ...
    return <SharedNavLayout navList={generalReducer.adminNav} logoLink={"/en/admin"} footerInnerValue={<p>ADMIN PAGE</p>}>
        <SupplierInformation supplier={supplier} token={props.token} />
    </SharedNavLayout>
}
