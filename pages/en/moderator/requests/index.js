...
import RequestsDashboard from "../../../../components/admin-moderator/Requests";
...
const Requests = (props) => {
  ...
  return (
    <SharedNavLayout navList={generalReducer.moderatorNav} logoLink={"/en/admin"} footerInnerValue={<p>MODERATOR PAGE</p>}>
        <RequestsDashboard token={props.token} moderator={true}/>
    </SharedNavLayout>
  );
};
